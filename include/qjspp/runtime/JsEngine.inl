...
template <typename T>
Object JsEngine::newInstanceOfView(bind::meta::ClassDefine const& def, T* instance, Object ownerJs) {
    struct Control {
        Object ownerJsInst;
...
template <typename T>
Object JsEngine::newInstanceOfUnique(bind::meta::ClassDefine const& def, std::unique_ptr<T>&& instance) {
    return newInstanceOfRaw<T>(def, instance.release());
}

template <typename T>
Object JsEngine::newInstanceOfShared(bind::meta::ClassDefine const& def, std::shared_ptr<T>&& instance) {
    struct Control {
...
template <typename T>
Object JsEngine::newInstanceOfWeak(bind::meta::ClassDefine const& def, std::weak_ptr<T>&& instance) {
    struct Control {
...
template <typename T>
T* JsEngine::getNativeInstanceOf(Object const& obj, bind::meta::ClassDefine const& def) const {
